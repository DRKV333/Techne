...
{
    [PluginExportAttribute("Turbo-Model-Thingy Cube-Visual3D", "0.1", "ZeuX", "Adds Support for TMT-Cubes", "DE81AA14-BD60-4228-8D8D-5238BCD3CAAA")]
    ...
    public class TurboModelThingyCubeVisual3DPlugin : IShapePlugin
    {
        ...
        public System.Windows.Media.Imaging.BitmapSource Icon
        {
            get
            {
                ...
                using (System.IO.Stream stream = myAssembly.GetManifestResourceStream("Techne.Plugins.Shapes.Resources.AddCube.png"))
                {
