...
namespace Techne
{
    /// <summary>Wraps another stream and provides reporting for when bytes are read or written to the stream.</summary>
    public class ProgressStream : Stream
    {
        ...
        #region Constructor
        /// <summary>Creates a new ProgressStream supplying the stream for it to report on.</summary>
        ...
        #region Events
        /// <summary>Raised when bytes are read from the stream.</summary>
        public event ProgressStreamReportDelegate BytesRead;

        /// <summary>Raised when bytes are written to the stream.</summary>
        public event ProgressStreamReportDelegate BytesWritten;

        /// <summary>Raised when bytes are either read or written to the stream.</summary>
    ...
    /// <summary>Contains the pertinent data for a ProgressStream Report event.</summary>
    public class ProgressStreamReportEventArgs : EventArgs
    {
        /// <summary>Default constructor for ProgressStreamReportEventArgs.</summary>
        public ProgressStreamReportEventArgs()
        {
        }

        /// <summary>Creates a new ProgressStreamReportEventArgs initializing its members.</summary>
        ...
        /// <summary>The number of bytes that were read/written to/from the stream.</summary>
        ...
        /// <summary>The total length of the stream in bytes.</summary>
        ...
        /// <summary>The current position in the stream.</summary>
        ...
        /// <summary>True if the bytes were read from the stream, false if they were written.</summary>
        public bool WasRead
        {
            get;
            private set;
    ...
    /// <summary>The delegate for handling a ProgressStream Report event.</summary>
