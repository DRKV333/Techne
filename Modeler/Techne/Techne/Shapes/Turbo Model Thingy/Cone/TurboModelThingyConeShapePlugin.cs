...
{
    [PluginExport("Turbo Model Thingy Cone Shape", "0.1", "ZeuX", "Adds Support for Turbo Model Thingies Cone", "0900DE04-664F-4789-8562-07FFE1043E90")]
    public class TurboModelThingyConeShapePlugin : IShapePlugin
    {
        private readonly Guid guid = new Guid("0900DE04-664F-4789-8562-07FFE1043E90");
        ...
        public BitmapSource Icon
        {
            get
            {
                ...
                using (Stream stream = myAssembly.GetManifestResourceStream("Techne.Plugins.FileHandler.TurboModelThingy.Resources.AddCone.png"))
                {
