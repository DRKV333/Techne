...
{
    [PluginExport("Turbo Model Thingy Cylinder Shape", "0.1", "ZeuX", "Adds Support for Turbo Model Thingies Cylinder", "B94B0064-E61C-4517-8F99-ADB273F1B33E")]
    public class TurboModelThingyCylinderShapePlugin : IShapePlugin
    {
        private readonly Guid guid = new Guid("B94B0064-E61C-4517-8F99-ADB273F1B33E");
        ...
        public BitmapSource Icon
        {
            get
            {
                ...
                using (Stream stream = myAssembly.GetManifestResourceStream("Techne.Plugins.FileHandler.TurboModelThingy.Resources.AddCylinder.png"))
                {
